...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "include_dirs": [
            "/home/clb02321/.local/lib/python2.7/site-packages/numpy/core/include"
        ], 
        "language": "c++", 
        "libraries": [
            "myclass"
        ...
        "library_dirs": [
            "/dls_sw/apps/openmpi/3.0.0/rhel6/x86_64/lib", 
            "/dls_sw/apps/cuda/9.1/lib64", 
            "/dls_sw/apps/gcc/5.5.0/lib64"
        ], 
        "name": "the_python_part.cpp_extension", 
        "sources": [
            "the_python_part/cpp_extension.pyx"
        ]
    }, 
    "module_name": "the_python_part.cpp_extension"
}
END: Cython Metadata */
...
#define __PYX_HAVE__the_python_part__cpp_extension
#define __PYX_HAVE_API__the_python_part__cpp_extension
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'the_python_part.cpp_extension' */
#define __Pyx_MODULE_NAME "the_python_part.cpp_extension"
extern int __pyx_module_is_main_the_python_part__cpp_extension;
int __pyx_module_is_main_the_python_part__cpp_extension = 0;

/* Implementation of 'the_python_part.cpp_extension' */
...
static int __pyx_pymod_exec_cpp_extension(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cpp_extension},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcpp_extension(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcpp_extension(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cpp_extension(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cpp_extension(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_cpp_extension(PyObject *__pyx_pyinit_module)
#endif
#endif
{
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cpp_extension(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cpp_extension", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_the_python_part__cpp_extension) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "the_python_part.cpp_extension")) {
      if (unlikely(PyDict_SetItemString(modules, "the_python_part.cpp_extension", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "the_python_part/cpp_extension.pyx":3
 * 
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init the_python_part.cpp_extension", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init the_python_part.cpp_extension");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
